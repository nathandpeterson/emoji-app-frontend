...
class Profile extends Component {
  ...
  renderAvatar = (user) => {
    return this.state.avatarEmoji ? <span className="animated fadeInUpBig">{this.state.avatarEmoji} </span> : <img className= "profile avatar" alt={'user'} src = {user.picture}></img>
  }
